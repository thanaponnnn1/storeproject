...
- [x] **7.5 หน้ารับของ (GR) / จ่ายของ (DO) แบบยิง barcode** — สแกนสะสมเป็น line แล้ว confirm, สินค้า SERIAL ยิง serial บนตัวเครื่องต่อเนื่องทีละเครื่อง, สินค้า LOT เลือก lot จากรายการ FEFO
- [x] **7.6 หน้าเดินเอกสารขาย** — QT → SO → DO → INV → Payment (ราคาขึ้นตาม price level ลูกค้าอัตโนมัติ)
- [x] **7.7 หน้าพิมพ์สติกเกอร์ QR** (ทำแล้วในเฟส 7.4) — ของไม่มี barcode โรงงาน (เหล็ก ท่อ ปูน) เลือกสินค้า+หน่วย → พิมพ์แผ่นสติกเกอร์ QR ติดชั้นวาง (พิมพ์จากหน้าเว็บได้เลย)
- [x] **7.8 หน้าเช็คประกัน/เคลม** (ทำแล้วในเฟส 7.4 — ยิง serial ในหน้าสแกน) — ยิง serial บนเครื่องลูกค้า → เห็นทันที ซื้อวันไหน ประกันเหลือกี่วัน
