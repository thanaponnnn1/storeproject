...
> เริ่มขนานได้ตั้งแต่จบเฟส 2 (API ฝั่งคลังนิ่งแล้ว)

- [ ] **7.1 Scaffold Next.js** (App Router + TS) + ต่อ auth (login, เก็บ token, auto refresh)
- [ ] **7.2 หน้า master data** — ตาราง + ฟอร์มสินค้า/คู่ค้า/คลัง
- [ ] **7.3 หน้า stock card + ยอดคงเหลือ**
- [ ] **7.4 หน้าสแกน barcode (มือถือ)**
